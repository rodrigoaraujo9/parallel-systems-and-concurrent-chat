...
void OnMultLine(int m_ar, int m_br, double *pha, double *phb,
                        double *phc) {
...
void OnMultBlock(int m_ar, int m_br, int bkSize, double *pha,
...
void OnMultBlockWrapper(int m_ar, int m_br, double *A, double *B,
                                double *C) {
