...
int main() {
  ...
  cout << "Test 3: Cache Size = " << cacheSize3
       << " bytes, usageFraction = 0.8, block size = " << blockSize3 << endl;
  ...
  cout << "Test 4: Cache Size = " << cacheSize4
       << " bytes, usageFraction = 0.8, block size = " << blockSize4 << endl;
  ...
  cout << "Test 5: Cache Size = " << cacheSize1
       << " bytes, usageFraction = 0.0, block size = " << blockSize5 << endl;
